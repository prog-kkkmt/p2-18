...
def main():
    ...
    mainwindow = Tk()
    # Задание размера окна и его координат расположения
    mainwindow.geometry("315x240+700+300")
    ...
    lb1 = Label(mainwindow, text="Деньги:", background="gray22", foreground="#ccc")
    lb1.place(x=20, y=10)
    lb1 = Label(mainwindow, text="Симулятор программиста", background="gray22", foreground="#ccc")
    lb1.place(x=80, y=40)
    b1 = Button(mainwindow, text="Работать", background="#555", foreground="#ccc", width=15, height=1, command=click)
    b1.place(x=100, y=70)
    b1 = Button(mainwindow, text="Персонаж", background="#555", foreground="#ccc", width=15, height=1, command=mainwindow1)
    b1.place(x=100, y=100)
    b1 = Button(mainwindow, text="Магазин", background="#555", foreground="#ccc", width=15, height=1, command=mainwindow1)
    b1.place(x=100, y=130)
    b1 = Button(mainwindow, text="Сохранить и выйти", background="#555", foreground="#ccc", width=15, height=1, command=mainwindow1)
    b1.place(x=100, y=160)
    box2 = Listbox(mainwindow, selectmode=EXTENDED, width=10, height=1)
    box2.place(x=70, y=12)
