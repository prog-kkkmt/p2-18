...
public class DirectorGetReportForAllWorkersDAO implements IDirectorGetReportForAllWorkersDAO {
    ...
    public List<WorkedDay> getReportForDays(LocalDate date, ReportDaysValue value) {
        ...
        try(Connection connection = DriverManager.getConnection(url, user,pass)){
            try(PreparedStatement state = connection.prepareStatement("SELECT name, date, hours FROM HOURS")){
