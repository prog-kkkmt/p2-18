...
public enum Role {
    ...
    DIRECTOR(Set.of(Permission.DIRECTOR_ADD_HOURS_TO_WORKER, Permission.DIRECTOR_MAKE_REPORT_FOR_WORKER, Permission.DIRECTOR_MAKE_REPORT_FOR_ALL,Permission.DIRECTOR_ADD_NEW_WORKER)),
